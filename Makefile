...
pkgdatadir = $(datadir)/mix
pkglibdir = $(libdir)/mix
pkgincludedir = $(includedir)/mix
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	TODO build-aux/depcomp build-aux/install-sh build-aux/mdate-sh \
...
am__aclocal_m4_deps = $(top_srcdir)/m4/error.m4 \
	...
	$(top_srcdir)/m4/onceonly_2_57.m4 $(top_srcdir)/m4/stdint.m4 \
	$(top_srcdir)/m4/stdlib_h.m4 $(top_srcdir)/m4/strerror.m4 \
	$(top_srcdir)/m4/sys_stat_h.m4 $(top_srcdir)/m4/sys_time_h.m4 \
	$(top_srcdir)/m4/tempname.m4 $(top_srcdir)/m4/ulonglong.m4 \
...
ACLOCAL = ${SHELL} /root/src/mix-2.0/build-aux/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /root/src/mix-2.0/build-aux/missing --run tar
AUTOCONF = ${SHELL} /root/src/mix-2.0/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /root/src/mix-2.0/build-aux/missing --run autoheader
AUTOM4TE = ${SHELL} /root/src/mix-2.0/build-aux/missing --run autom4te
AUTOMAKE = ${SHELL} /root/src/mix-2.0/build-aux/missing --run automake-1.9
AWK = mawk
BITSIZEOF_PTRDIFF_T = 
...
LTLIBINTL = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/src/mix-2.0/build-aux/missing --run makeinfo
...
OBJEXT = o
PACKAGE = mix
PACKAGE_BUGREPORT = gray@gnu.org.ua
PACKAGE_NAME = mix
PACKAGE_STRING = mix 2.0
PACKAGE_TARNAME = mix
PACKAGE_VERSION = 2.0
PATH_SEPARATOR = :
PTRDIFF_T_SUFFIX = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  exitfail.o tempname.o xmalloc.o
gl_LTLIBOBJS =  exitfail.lo tempname.lo xmalloc.lo
host_alias = 
htmldir = ${docdir}
includedir = ${prefix}/include
infodir = ${datarootdir}/info
install_sh = /root/src/mix-2.0/build-aux/install-sh
...
AUTOMAKE_OPTIONS = gnu 1.9
SUBDIRS = yfmt gnu lib src elisp examples doc tests
all: config.h
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/build-aux $(distdir)/m4 $(distdir)/tests
